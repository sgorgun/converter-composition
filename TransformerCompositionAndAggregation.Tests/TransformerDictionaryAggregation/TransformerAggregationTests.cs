...
using Transformer = TransformerDictionaryAggregation.Transformer;

namespace TransformerCompositionAndAggregation.Tests.TransformerDictionaryAggregation
{
    [TestFixture]
    public class TransformerAggregationTests
    {
        ...
        public void TransformToWords_DictionaryIsNull_ThrowArgumentNullException()
        {
            Assert.Throws<ArgumentNullException>(
                () => new Transformer(null), "Dictionary cannot be null.");
        }

        private SymbolsDictionary CreateEnglishDictionary() => new()
        {
